...
function Bar({ active, setActive, setSection }: BarProps) {
  ...
  return (
    <div className={`bar ${active ? "active" : ""}`}>
      <div className="flex justify-between">
        <h1>Logo</h1>
        {active && (
          <IoArrowBackCircleOutline onClick={() => setActive(false)} />
        )}
      </div>
      <ul>
        <li className="reefi">
        ...
        <li onClick={() => setSection("Order Analysis")}>
          <Image src={"/message.png"} width={"30"} height={"30"} alt="" /> Order
          Analysis
        </li>
        ...
        <li onClick={() => setSection("Coupons")}>
          <Image src={"/coupons.png"} width={"30"} height={"30"} alt="" />{" "}
          Coupons
        </li>
        <li onClick={() => setSection("Countries")}>
          <Image src={"/Countries.png"} width={"30"} height={"30"} alt="" />{" "}
          Countries
        </li>
        <li onClick={() => setSection("Payments")}>
          <Image src={"/Payments.png"} width={"30"} height={"30"} alt="" />{" "}
          Payments
        </li>
        <li onClick={() => setSection("Shipping")}>
          <Image src={"/Shipping.png"} width={"30"} height={"30"} alt="" />{" "}
          Shipping
        </li>
        <li onClick={() => setSection("Delivery tool indicator")}>
          <Image src={"/Delivery.png"} width={"30"} height={"30"} alt="" />{" "}
          Delivery tool indicator
        </li>
        <li onClick={() => setSection("Retarget")}>
          <Image src={"/Retarget.png"} width={"30"} height={"30"} alt="" />{" "}
          Retarget
        </li>
        <li onClick={() => setSection("Data bank")}>
          <Image src={"/Data.png"} width={"30"} height={"30"} alt="" /> Data
          bank
        </li>
